Below is the original readme from the App Brewery Bootcamp course.  
This is a rewrite of the code I wrote in the bootcamp using things I've learned to make it my own and unique.
NOTE: This has the free api account so it can't handle a ton of requests currently.
